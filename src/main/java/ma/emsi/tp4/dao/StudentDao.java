...
public class StudentDao {
    private static final String SELECT_STUDENTS = "select * from students where last_name like ?";
    private String jdbcURL = "jdbc:mysql://localhost:3306/tpjee?useSSL=false";
    private String jdbcUsername = "root";
    private String jdbcPassword = "3883";
    private static final String INSERT_STUDENTS_SQL = "INSERT INTO students" +
            ...
            " (?, ?, ?, ?, ?, ?);";
    private static final String SELECT_STUDENT_BY_ID = "select id, first_name, last_name, student_id," +
            " school, study_option, registration_year from students where id =?";
    private static final String SELECT_ALL_STUDENTS = "select * from students";
    private static final String DELETE_STUDENTS_SQL = "delete from students where id = ?;";
    private static final String UPDATE_STUDENTS_SQL = "update students set first_name = ?, last_name= ?," +
            " student_id= ?, school=?, study_option=?, registration_year=? where id = ?";
    public StudentDao() {
    }
